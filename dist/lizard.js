...
var hx = (0, _hyperx2.default)(_virtualDom2.default.h);

var Lizard = function () {
  _createClass(Lizard, null, [{
    key: 'html',
    get: function get() {
      return hx;
    }
  ...
  _createClass(Lizard, [{
    key: 'data',
    value: function data(attr, value) {
      if (attr === undefined) {
        return this._data;
      }
      ...
      if (value !== undefined) {
        ...
        } else if (_typeof(this._data[attr]) === 'object') {
    ...
    value: function render(element) {
      ...
      if (!this._element) {
        throw new Error('Please ensure the DOM element exists or was defined before ' + 'rendering a template into it.');
      }
      ...
      // create virtual dom
      this._mainLoop = (0, _mainLoop2.default)(this.data(), function () {
        return _this.view.call(_this.data(), _this);
      }, _virtualDom2.default);

      this._element.appendChild(this._mainLoop.target);

      return new Promise(function (resolve) {
        resolve(_this._mainLoop.target);
      });
    }
  }, {
    key: 'toRender',
    value: function toRender(instance) {
      if (instance) {
    ...
    key: 'redrawTo',
    value: function redrawTo(instance) {
    ...
    value: function redraw() {
      ...
      this._redrawTo.forEach(function (instance) {
...
},{"hyperx":9,"main-loop":13,"virtual-dom":21,"virtual-dom/create-element":18}],2:[function(require,module,exports){
...
},{"camelize":4,"string-template":17,"xtend/mutable":46}],6:[function(require,module,exports){
'use strict';
...
},{"error/typed":5,"raf":16}],14:[function(require,module,exports){
(function (process){
...
},{"./vdom/create-element.js":24}],19:[function(require,module,exports){
var diff = require("./vtree/diff.js")

module.exports = diff

},{"./vtree/diff.js":44}],20:[function(require,module,exports){
var h = require("./virtual-hyperscript/index.js")

module.exports = h

},{"./virtual-hyperscript/index.js":31}],21:[function(require,module,exports){
...
},{"./create-element.js":18,"./diff.js":19,"./h.js":20,"./patch.js":22,"./vnode/vnode.js":40,"./vnode/vtext.js":42}],22:[function(require,module,exports){
...
},{"../vnode/is-vhook.js":35,"is-object":12}],24:[function(require,module,exports){
...
},{"../vnode/handle-thunk.js":33,"../vnode/is-vnode.js":36,"../vnode/is-vtext.js":37,"../vnode/is-widget.js":38,"./apply-properties":23,"global/document":7}],25:[function(require,module,exports){
...
},{"./create-element":24,"./dom-index":25,"./patch-op":26,"global/document":7,"x-is-array":45}],28:[function(require,module,exports){
var isWidget = require("../vnode/is-widget.js")
...
},{"ev-store":6}],30:[function(require,module,exports){
'use strict';
...
},{"browser-split":3}],33:[function(require,module,exports){
...
},{"../vnode/is-vhook":35,"is-object":12}],44:[function(require,module,exports){
var isArray = require("x-is-array")
